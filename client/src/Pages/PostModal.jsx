...
const PostModal = () => {
  ...
  return (
    <div className="fixed bg-black z-1000 bg-opacity-60 inset-0" 
      ...
      <div onClick = {(e) => e.stopPropagation()} 
        className='max-w-[940px] transform scale-90 animate-scaileUp 
        rounded-md h-[32rem] overflow-hidden bg-white mt-32 mx-auto grid grid-cols-2'>
        <div>
